...
//
//  Created by Blaine Dannheisser on 1/29/21.
//
...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    var currentFilter: CIFilter! {
        didSet {
            let buttonTitle = currentFilter.name.replacingOccurrences(of: "CI", with: "")
            changeFilter.setTitle(buttonTitle, for: .normal)
        }
    }
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "📷", style: .plain, target: self, action: #selector(importPicture))
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey: Any]) {
        ...
        // set current image as input image for current filter then apply processing
